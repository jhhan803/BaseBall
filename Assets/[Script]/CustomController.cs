...
public class CustomController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(handInstance!=null&&controllerInstance!=null)
                    {
            if (renderController)
            {
        ...
        //    {
        //        if(triggerButton == false && currentHand == HandGun.GetComponent<SimpleShoot2>().currentGrab)
        //        {
        //            HandGun.GetComponent<SimpleShoot2>().Shoot();
        //            triggerButton = true;
        //        }                
        //    }
        //    else
